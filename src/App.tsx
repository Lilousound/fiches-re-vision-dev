...
function App() {
  ...
  return (
    ...
    >
      <aside className="relative flex max-h-[min(48vh,100%)] shrink-0 flex-col border-b border-[var(--color-app-border)] md:h-dvh md:max-h-none md:w-[min(22rem,100%)] md:border-b-0 md:border-r">
